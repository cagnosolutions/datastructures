...
func (t *Tree) First() (k int64, v []byte) {
	if q := t.first; q != nil {
		q := &q.d[0]
		k, v = q.k, q.v
	}
...
func (t *Tree) Get(k int64) (v []byte, ok bool) {
	q := t.r
	if q == nil {
		return
	}
...
func (t *Tree) Last() (k int64, v []byte) {
	if q := t.last; q != nil {
		q := &q.d[q.c-1]
		k, v = q.k, q.v
	}
...
func (t *Tree) Put(k int64, upd func(oldV []byte, exists bool) (newV []byte, write bool)) (oldV []byte, written bool) {
	pi := -1
	var p *x
	q := t.r
	var newV []byte
...
func (t *Tree) Set(k int64, v []byte) {
	//dbg("--- PRE Set(%v, %v)\n%s", k, v, t.dump())
	//defer func() {
	//  dbg("--- POST\n%s\n====\n", t.dump())
	//}()
